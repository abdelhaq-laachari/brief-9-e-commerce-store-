...
<?php $post_option = get_theme_mod( 'business_consulting_lite_grid_column','3_column');
			...
			<div class="postbox smallpostimage p-2 mb-3">
	        	...
	        	<div class="overlay pt-2 text-center">
	        		<div class="date-box mb-2">
	        			<?php if( get_theme_mod('business_consulting_lite_date',true) != ''){ ?>
	        				<span class="mr-2"><i class="far fa-calendar-alt mr-2"></i><?php the_time( get_option( 'date_format' ) ); ?></span>
	        			<?php } ?>
	        			<?php if( get_theme_mod('business_consulting_lite_admin',true) != ''){ ?>
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('business_consulting_lite_comment',true) != ''){ ?>
	      					<span class="entry-comments"><i class="fas fa-comments mr-2"></i> <?php comments_number( __('0 Comments','business-consulting-lite'), __('0 Comments','business-consulting-lite'), __('% Comments','business-consulting-lite')); ?></span>
	      				<?php }?>
	    			</div>
	        		<p><?php the_excerpt();?></p>
	        	</div>
