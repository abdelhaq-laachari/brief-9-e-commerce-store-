 ...
 * @access public
 */
class Business_Consulting_Lite_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'business-consulting-lite-toggle-control-styles', get_parent_theme_file_uri( 'assets/css/toggle.css' ), false, '1.0.0', 'all' );
	}
