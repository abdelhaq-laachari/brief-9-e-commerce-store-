...
function business_consulting_lite_custom_styles($custom) {
	...
	wp_add_inline_style( 'business-consulting-lite-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'business_consulting_lite_custom_styles' );

//Sanitizes Fonts
function business_consulting_lite_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
